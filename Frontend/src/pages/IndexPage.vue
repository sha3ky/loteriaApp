    ...
    <div class="q-pa-md q-gutter-sm">
      ...
      >
        <q-card class="text-white dialog-card">
          <q-card-section style="display: contents" v-if="nombreGanador">
            <div style="padding: 20%">
              <div
                class="text-h6"
                style="text-align: center; text-transform: uppercase"
              >
                La gandora o el Ganador es {{ nombreGanador }}
              </div>
              <div class="sign">
          ...
          <q-card-section style="display: contents" v-else>
            <div style="padding: 20%">
              <div
                class="text-h6"
                style="text-align: center; text-transform: uppercase"
...
.dialog-card {
  width: calc(80vh - 10px); /* Ajusta el ancho teniendo en cuenta variaciones */
  height: calc(70vh - 10px); /* Ajusta la altura */
  background: rgba(0, 0, 0, 0.5);
  backdrop-filter: blur(10px);
  border-radius: 15px;
}
